...
export default function WhyChooseCard({ icon: Icon, item }) {
  return (
    <article className="feature-card h-full text-center">
      <div className="mx-auto grid h-14 w-14 place-items-center rounded-full bg-brand-gold/10 text-brand-gold">
